...
document
  ...
  .addEventListener("submit", function (e) {
    ...
    fetch(
      "https://script.google.com/macros/s/AKfycbyWcSZtEVAh7Yndm8UAT11QhVrUIOusVOEjKnK-Esmk0KrMC4-yttBQ-obcRtaTaKyQZw/exec",
      {
        method: "POST",
        mode: "no-cors",
        headers: {
      ...
      .then(() => {
        document.getElementById("mce-success-response").innerHTML =
          "🎉 Awesome! You're on the waitlist. We'll notify you when chillish launches!";
